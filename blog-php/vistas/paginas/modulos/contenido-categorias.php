<?php
	...
	if (isset($rutas[1])){
		...
		if (is_numeric($rutas[1])){
			...
			$articulos = ControladorBlog::ctrMostrarConInnerJoin($desde, 5, "ruta_categoria", $rutas[0]);
		...
		<div class="row">
			...
			<div class="col-12 col-md-8 col-lg-9 p-0 pr-lg-5">
				...
				<div class="container d-none d-md-block">
					...
					<ul class="pagination justify-content-center" totalPaginas="<?php echo $totalArticulos; ?>" paginaActual="<?php echo $paginaActual; ?>" rutaPagina="<?php echo $articulos[0]["ruta_categoria"]; ?>"></ul>
						...
						<?php
							...
							foreach ($tags as $key => $value){
								...
								echo '
									...
									<a href="#suramerica" class="btn btn-secondary btn-sm m-1">'.$value.'</a>
